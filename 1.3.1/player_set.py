...
bets_df = spark.read.csv("d:/DA-DE-1.3/1.3.1/bets.csv", header=True, inferSchema=True)
events_df = spark.read.csv("d:/DA-DE-1.3/1.3.1/events.csv", header=True, inferSchema=True)
